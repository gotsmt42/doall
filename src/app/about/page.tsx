        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <SectionHeading
              ...
              description="พร้อมให้บริการงานระบบป้องกันอัคคีภัยและความปลอดภัยอาคารครอบคลุมทุกภูมิภาคทั่วประเทศไทย ทั้งงานติดตั้งระบบใหม่และงานบำรุงรักษา ทีมงานพร้อมเข้าสำรวจหน้างานและดูแลโครงการได้ในทุกจังหวัด"
            />
